...
## Анализ QC прочтений
Мною был выбран образец 8cell. Изучив полученные данные я сделал вывод, что GC-нуклеотиды преобладают над повышенными рисками. Данные из статьи нам не противоречат. Можно исследовать, что %GC ниже, чем при секвенировании, например, РНК, так как часть цитозинов (а именно неметилированные цитозины) в ходе бисульфидного секвинирования заменяется на урацилы.
